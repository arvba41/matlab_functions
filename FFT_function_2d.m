function [X_cpx,f] = FFT_function_2d(x,t)
% [X_cpx,f] = FFT_function_2d(x,t) is the discrete Fourier transform (DFT) 
% of vector x, along the 2nd dimension, where t is the time vector 

L = length(t); % Sample length
dt = mean(diff(t)); % sampling period
fs= 1/dt; % sampling frequency

Y = fft(x,[],2); % Computing FFT
